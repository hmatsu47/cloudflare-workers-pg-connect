...
// .wrangler/tmp/bundle-uadsDy/checked-fetch.js
      ...
      for (var i = 0; i < val.length; i++) {
        ...
        if (val[i] === null || typeof val[i] === "undefined") {
          ...
          if (!(item instanceof Buffer2)) {
            var buf = Buffer2.from(item.buffer, item.byteOffset, item.byteLength);
...
var require_utils_webcrypto = __commonJS({
  "node_modules/pg/lib/crypto/utils-webcrypto.js"(exports, module) {
    ...
    async function postgresMd5PasswordHash(user, password, salt) {
      ...
      var outer = await md5(Buffer2.concat([Buffer2.from(inner), salt]));
      return "md5" + outer;
    }
...
var require_sasl = __commonJS({
  "node_modules/pg/lib/crypto/sasl.js"(exports, module) {
    ...
    async function continueSession(session, password, serverData) {
      ...
      var clientProof = xorBuffers(Buffer2.from(clientKey), Buffer2.from(clientSignature)).toString("base64");
...
var init_dist = __esm({
  "node_modules/pg-cloudflare/dist/index.js"() {
    ...
    init_buffer();
    init_events();
    CloudflareSocket = class extends EventEmitter {
      constructor(ssl) {
        super();
        this.ssl = ssl;
        this.writable = false;
  ...
  "node_modules/pg/lib/stream.js"(exports, module) {
    ...
    module.exports.getStream = function getStream(ssl) {
      ...
      if (typeof net.Socket === "function") {
        ...
        const { CloudflareSocket: CloudflareSocket2 } = (init_dist(), __toCommonJS(dist_exports));
    ...
    var Pool = class extends EventEmitter2 {
      ...
      connect(cb) {
        ...
        if (this._isFull() || this._idle.length) {
          ...
          const queueCallback = (err, res, done2) => {
            clearTimeout(tid);
...
// .wrangler/tmp/bundle-uadsDy/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();

// .wrangler/tmp/bundle-uadsDy/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
init_process();
init_buffer();
...
var src_default = {
  async fetch(request, env3, ctx) {
    ...
    const client = new import_pg.Client(env3.DB_URL);
